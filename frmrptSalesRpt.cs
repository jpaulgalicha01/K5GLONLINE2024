...
{
    public partial class frmrptSalesRpt : Form
    {
        ...
        public frmrptSalesRpt()
        {
            ...
            var items = new[]
            { 
             new { Text = "Sales - Salesman - Supplier - Summary", Value = "01" }, 
        ...
        {
            string sqlstatement;
            sqlstatement = "SELECT SalesType, CustName, SUM(ConvertedQty) As ConvertedQty, SUM(VAT) As VAT, SUM(GrossAmt) As GrossAmt, SUM(Discount) As Discount ";
            sqlstatement += "FROM ViewSalesSalesman  WHERE PC = '" + cboSalesman.SelectedValue.ToString() + "' AND ClassCode = '" + cboSupplierCode.SelectedValue.ToString() + "' AND TDate BETWEEN '" + txtBeginDate.Text + "' And  '" + txtEndDate.Text + "'";
            sqlstatement += "GROUP By SalesType, CustName ";
            ...
            CRSalesmanSupplierSummary objRpt = new CRSalesmanSupplierSummary();
        ...
        private void frmrptSalesRpt_Load(object sender, EventArgs e)
        {
