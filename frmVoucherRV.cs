...
{
    public partial class frmVoucherRV : Form
    {
       ...
       // SqlDataReader dr;
        ...
        public frmVoucherRV()
        {
            InitializeComponent();
            {
                ClsGetSomethingOthers1.ClsGetVoidRef("RV");
                privarstrVoidIC = ClsGetSomethingOthers1.plsVoidIC;
                if (new ClsValidation().emptytxt(privarstrVoidIC))
                { }
                else
                {
                    ClsGetSomethingOthers1.ClsDeleteErrorTransaction("RV");
                }

            }
        }

        private void frmVoucherRV_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ClsAutoNumber1.VoucherAutoNum("RV");
        ...
        private void RVSave()
        {
            try
            {
                    ...
                    mycommand.Parameters.Add("_IC", SqlDbType.VarChar).Value = "RV" + Form1.glbluc.Text;
                    mycommand.Parameters.Add("_DocNum", SqlDbType.VarChar).Value = Form1.glbluc.Text;
                    mycommand.Parameters.Add("_Voucher", SqlDbType.VarChar).Value = "RV";
                    ...
                    mycommand.Parameters.Add("_Reference", SqlDbType.VarChar).Value = "RV" + txtDocNum.Text;
                    ...
                    mycommand.Parameters.Add("_SONumber", SqlDbType.VarChar).Value = "RV" + txtDocNum.Text;
                    ...
                    for (int x = 0; x < dgv1.Rows.Count - 1; x++)
                    {
                        ...
                        mycommand.Parameters.Add("_RVRefer", SqlDbType.VarChar).Value = row.Cells[2].Value;
                        mycommand.Parameters.Add("_SIT", SqlDbType.Bit).Value = row.Cells[6].Value;
                        mycommand.CommandTimeout = 600;
                        int n2 = mycommand.ExecuteNonQuery();
                    }
                    myconnection.Close();
                    ClsGetSomethingOthers1.ClsFinalize("RV", txtDocNum.Text);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else if (new ClsValidation().emptytxt(dgvdata))
            {
            ...
            else
                {
                    myconnection.Close();
                    privarstrVoidIC = null;
                    ClsGetSomethingOthers1.ClsGetTDoor("RV");
                    ...
                    if (varintTableDoor == 0 && number <= 20)
                    {
                        ...
                        if (new ClsValidation().emptytxt(privarstrVoidIC))
                        {
                            ClsGetSomethingOthers1.ClsOneTheDoor("RV");
                            RVSave();
                            ClsGetSomethingOthers1.ClsZeroTheDoor("RV");
                        }
                        else
                        {
                            ClsGetSomethingOthers1.ClsDeleteErrorTransaction("RV");
        ...
        private void txtTDate_Leave(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                txtreference.Text = "RV" + txtDocNum.Text;
            }
        ...
        private void printcurvoucher()
        {
            ...
            sqlstatement = "SELECT CustName, Reference, DocNum, TDate, Term, PA, TitleAcct, Debit, Credit, UserName, Remarks FROM viewrv WHERE DocNum ='" + txtDocNum.Text + "'";
        ...
        private void btnActGroup_Click(object sender, EventArgs e)
        {
            ...
            frmActGroupJV1.Show();
            frmActGroupJV.glbltxtVoucher.Text = "RV";
        }
        ...
        private void btnVAT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                frmVATEntry1.Show();
                frmVATEntry.glbltxtVoucher.Text = "RV";
