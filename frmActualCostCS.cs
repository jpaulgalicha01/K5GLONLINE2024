...
{
    public partial class frmActualCostCS : Form
    {
        ...
        private void buildlvActCost()
        {
            try
            {
                ...
                myconnection.Open();
                mycommand = new SqlCommand("SELECT RefforAC, MaxTDate, SumBal, MaxActualCost FROM ViewActualCostProducts2 WHERE StockNumber = '"+frmVoucherCS.glblcboStockNumber.SelectedValue.ToString()+"'", myconnection);
        ...
        private void frmActualCostCS_Load(object sender, EventArgs e)
        {
            buildlvActCost();
        }
        ...
        private void LVpso_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (LVActCost.SelectedItems.Count > 0)
            {
                ...
                frmVoucherCS.glbltxtCostRef.Text = itm.SubItems[0].Text;
                frmVoucherCS.glbltxtCost.Text = itm.SubItems[3].Text;
            }
        }
