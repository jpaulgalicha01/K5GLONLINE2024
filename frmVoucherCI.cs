...
{
    public partial class frmVoucherCI : Form
    {
        public static ComboBox glblcboWHCode, glblcboControlNo, glblcboPC, glblcboStockNumber;
        public static TextBox glbltxtreference, glbltxtTerm, glbltxtD1, glbltxtD2, glbltxtD3, glbltxtPONum, glbltxtSODocNum, glbltxtCostRef, glbltxtCost;
        public static TextBox glbltxtTotActDisct, glbltxtTotPDisct, glbltxtTotVat, glbltxtTotSales, glbltxtTotCost, glbltxtTotNet;
        public static CheckBox glblcbSOTransact;
        ...
        public frmVoucherCI()
        {
            InitializeComponent();
            {
                ClsGetSomethingOthers1.ClsGetVoidRef("CI");
                privarstrVoidIC = ClsGetSomethingOthers1.plsVoidIC;
                if (new ClsValidation().emptytxt(privarstrVoidIC))
                { }
                else
                {
                    ClsGetSomethingOthers1.ClsDeleteErrorTransaction("CI");
                }
            }
        }

        private void frmVoucherCI_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ClsAutoNumber1.VoucherAutoNum("CI");
        ...
        private void buildcboControlNo()
        {
            ...
            this.cboControlNo.DropDownWidth = 450;
        }
        ...
        private void buildcboStocks()
        {
            ...
            this.cboStockNumber.DropDownWidth = 450;
        }
        ...
        private void cboControlNo_Validating(object sender, CancelEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    txtAddress.Text = ClsGetSomething1.plsBusAddress;
                    txtBusinessType.Text = ClsGetSomething1.plsBusinessType;
                }
            }
            catch (Exception ex)
            {
       ...
       !String.IsNullOrEmpty(values[2]) || !String.IsNullOrEmpty(values[3]))
        ...
        private void CISave()
        {
            try
            {
                ...
                mycommand.Parameters.Add("_IC", SqlDbType.VarChar).Value = "CI" + Form1.glbluc.Text;
                mycommand.Parameters.Add("_DocNum", SqlDbType.VarChar).Value = Form1.glbluc.Text;
                mycommand.Parameters.Add("_Voucher", SqlDbType.VarChar).Value = "CI";
                ...
                mycommand.Parameters.Add("_SONumber", SqlDbType.VarChar).Value = "CI" + txtDocNum.Text;
                ...
                for (int x = 0; x < dgv2.Rows.Count - 1; x++)
                {
                    ...
                    mycommanddgv2.Parameters.Add("_IC", SqlDbType.VarChar).Value = "CI" + Form1.glbluc.Text;
                ...
                {
                    sqlstatementupdate = "UPDATE tblMain6 set Serve=@_Serve WHERE DocNum= '" + txtSODocNum.Text + "' AND PONum = '" + txtPONum.Text + "'";
                ...
                myconnection.Close();
                ClsGetSomethingOthers1.ClsFinalize("CI", txtDocNum.Text);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            dgv1.Rows.Clear();
            getAcctEntry();
            if (new Clsexist().RecordExists(ref myconnection, "SELECT Reference FROM tblMain1 WHERE Reference ='" + txtreference.Text + "' AND Void=0 "))
            {
                myconnection.Close();
                dgv1.Rows.Clear();
            ...
            else if ((txtTDate.Text == "  /  /") || (txtVDate.Text == "  /  /"))
            {
                ...
                (new ClsValidation().emptytxt(cboControlNo.Text)) || (new ClsValidation().emptytxt(txtTerm.Text))
                || (new ClsValidation().emptytxt(txtD1.Text)) || (new ClsValidation().emptytxt(txtD2.Text))
            ...
            else
            {
                myconnection.Close();
                privarstrVoidIC = null;
                ClsGetSomethingOthers1.ClsGetTDoor("CI");
                ...
                if (varintTableDoor == 0 && number <= 20)
                {
                    ...
                    if (new ClsValidation().emptytxt(privarstrVoidIC))
                    {
                        ClsGetSomethingOthers1.ClsOneTheDoor("CI");
                        CISave();
                        ClsGetSomethingOthers1.ClsZeroTheDoor("CI");
                    }
                    else
                    {
                        ClsGetSomethingOthers1.ClsDeleteErrorTransaction("CI");
        ...
        private void printcurvoucher()
        {
            ...
            sqlstatement = "SELECT * FROM viewCI WHERE DocNum ='" + txtDocNum.Text + "' ORDER BY Num";
        ...
        private void cboStockNumber_Validating(object sender, CancelEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        frmActualCostCI frmActualCostCI1 = new frmActualCostCI();
                        frmActualCostCI1.Show();
                        txtCostRef.Text = "";
                    }
                }
            }
        ...
        private void getproductdetails()
        {
            ...
            if (double.Parse(txtIB.Text) == 0)
            {
                ...
                txtOrdQPC.Enabled = true;  //balik sa true
            }
            else
            {
        ...
        private void getproductBalance()
        {
            ...
            ClsGetSomething1.ClsGetConvertedPieceBal(double.Parse(txtTotPCBal.Text), int.Parse(txtIB.Text), int.Parse(txtPiece.Text));//here
        ...
        private void txtD3_Validating(object sender, CancelEventArgs e)
        {
            ...
            else if (double.Parse(numStringD3)<0)
            {
                MessageBox.Show("Invalid Number", "GL");
                txtD3.Focus();
            }
        ...
        private void savetodgv()
        {
            ...
            else if ((Convert.ToDouble(txtOrdQCS.Text) != 0) && ((cboStockNumber.Text) != ""))
            {
                ...
                if ((vargrosssales-(double.Parse(txtActDisct.Text) + double.Parse(txtPDisct.Text)+ double.Parse(transactVATAmt)))> vargrosssales)
                {
                    ...
                    MessageBox.Show(vargrosssales.ToString());
                    cboStockNumber.Focus();
                }
                else
                {
        ...
        private void frmVoucherCI_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                frmPendingSO frmPendingSO1 = new frmPendingSO();
                frmPendingSO1.Show();
            }
        }

        private void btnPendingSO_Click(object sender, EventArgs e)
        {
            frmPendingSO frmPendingSO1 = new frmPendingSO();
            frmPendingSO1.Show();
        }

        private void newdgv2column()
        {
            ...
            Columndgv2StockNumber.SortMode = DataGridViewColumnSortMode.NotSortable;
            ...
            //ColumnCR.ReadOnly = true;
            dgv2.Columns.Add(Columndgv2Item);
            ...
            //ColumnCR.ReadOnly = true;
            dgv2.Columns.Add(Columndgv2ChickOut);
            ...
            //ColumnCR.ReadOnly = true;
            dgv2.Columns.Add(Columndgv2Out);
            ...
            Columndgv2Cost.SortMode = DataGridViewColumnSortMode.NotSortable;
            ...
            ColumnRefforAC.SortMode = DataGridViewColumnSortMode.NotSortable;
            dgv2.Columns.Add(ColumnRefforAC);


            dgv2.Columns[0].Name = "StockNumber";
            dgv2.Columns[1].Name = "Item";
            dgv2.Columns[2].Name = "Qty";
            dgv2.Columns[3].Name = "Qty/Weight";
            dgv2.Columns[4].Name = "UM";
            dgv2.Columns[5].Name = "UP";
            dgv2.Columns[6].Name = "ActDisct";
            dgv2.Columns[7].Name = "PDisct";
            dgv2.Columns[8].Name = "VAT";
            dgv2.Columns[9].Name = "Total";
            dgv2.Columns[10].Name = "Cost";
            dgv2.Columns[11].Name = "RefforAC";
        }
