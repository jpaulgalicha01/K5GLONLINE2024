...
{
    public partial class frmActualCostTF : Form
    {
        ...
        private void buildlvActCost()
        {
            try
            {
                ...
                myconnection.Open();
                mycommand = new SqlCommand("SELECT RefforAC, MaxTDate, SumBal, MaxActualCost FROM ViewActualCostProducts2 WHERE StockNumber = '"+frmVoucherTF.glblcboStockNumber.SelectedValue.ToString()+"'", myconnection);
        ...
        private void frmActualCostTF_Load(object sender, EventArgs e)
        {
            buildlvActCost();
        }
        ...
        private void LVpso_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (LVActCost.SelectedItems.Count > 0)
            {
                ...
                frmVoucherTF.glbltxtCostRef.Text = itm.SubItems[0].Text;
                frmVoucherTF.glbltxtCost.Text = itm.SubItems[3].Text;
            }
        }
