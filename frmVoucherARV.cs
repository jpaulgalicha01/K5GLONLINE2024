...
{
    public partial class frmVoucherARV : Form
    {
       ...
       // SqlDataReader dr;
        ...
        public frmVoucherARV()
        {
            InitializeComponent();
            {
                ClsGetSomethingOthers1.ClsGetVoidRef("ARV");
                privarstrVoidIC = ClsGetSomethingOthers1.plsVoidIC;
                if (new ClsValidation().emptytxt(privarstrVoidIC))
                { }
                else
                {
                    ClsGetSomethingOthers1.ClsDeleteErrorTransaction("ARV");
                }
            }
        }

        private void frmVoucherARV_Load(object sender, EventArgs e)
        {
            ...
            {
                ClsAutoNumber1.VoucherAutoNum("ARV");
        ...
        private void ARVSave()
        {
            try
            {
                    ...
                    mycommand.Parameters.Add("_IC", SqlDbType.VarChar).Value = "ARV" + Form1.glbluc.Text;
                    mycommand.Parameters.Add("_DocNum", SqlDbType.VarChar).Value = Form1.glbluc.Text;
                    mycommand.Parameters.Add("_Voucher", SqlDbType.VarChar).Value = "ARV";
                    ...
                    mycommand.Parameters.Add("_SONumber", SqlDbType.VarChar).Value = "ARV" + txtDocNum.Text;
                    ...
                    myconnection.Close();
                    ClsGetSomethingOthers1.ClsFinalize("ARV", txtDocNum.Text);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    myconnection.Close();
                    privarstrVoidIC = null;
                    ClsGetSomethingOthers1.ClsGetTDoor("ARV");
                    ...
                    if (varintTableDoor == 0 && number <= 20)
                    {
                        ...
                        if (new ClsValidation().emptytxt(privarstrVoidIC))
                        {
                            ClsGetSomethingOthers1.ClsOneTheDoor("ARV");
                            ARVSave();
                            ClsGetSomethingOthers1.ClsZeroTheDoor("ARV");
                        }
                        else
                        {
                            ClsGetSomethingOthers1.ClsDeleteErrorTransaction("ARV");
        ...
        private void printcurvoucher()
        {
            ...
            sqlstatement = "SELECT CustName, Reference, DocNum, TDate, Term, PA, TitleAcct, Debit, Credit, UserName, Remarks FROM viewbookarv WHERE DocNum ='" + txtDocNum.Text + "'";
        ...
        private void btnActGroup_Click(object sender, EventArgs e)
        {
            ...
            frmActGroupJV1.Show();
            frmActGroupJV.glbltxtVoucher.Text = "ARV";
        ...
        private void btnVAT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                frmVATEntry1.Show();
                frmVATEntry.glbltxtVoucher.Text = "ARV";
