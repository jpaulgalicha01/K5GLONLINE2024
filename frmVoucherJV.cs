...
{
    public partial class frmVoucherJV : Form
    {
       ...
       // SqlDataReader dr;
        ...
        private void frmVoucherJV_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ClsAutoNumber1.VoucherAutoNum("JV");
        ...
        private void JVSave()
        {
            try
            {
                    ...
                    mycommand.Parameters.Add("_IC", SqlDbType.VarChar).Value = "JV" + Form1.glbluc.Text;
                    mycommand.Parameters.Add("_DocNum", SqlDbType.VarChar).Value = Form1.glbluc.Text;
                    mycommand.Parameters.Add("_Voucher", SqlDbType.VarChar).Value = "JV";
                    ...
                    mycommand.Parameters.Add("_SONumber", SqlDbType.VarChar).Value = "JV" + txtDocNum.Text;
                    ...
                    myconnection.Close();
                    ClsGetSomethingOthers1.ClsFinalize("JV", txtDocNum.Text);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    myconnection.Close();
                    privarstrVoidIC = null;
                    ClsGetSomethingOthers1.ClsGetTDoor("JV");
                    ...
                    if (varintTableDoor == 0 && number <= 20)
                    {
                        ...
                        if (new ClsValidation().emptytxt(privarstrVoidIC))
                        {
                            ClsGetSomethingOthers1.ClsOneTheDoor("JV");
                            JVSave();
                            ClsGetSomethingOthers1.ClsZeroTheDoor("JV");
                        }
                        else
                        {
                            ClsGetSomethingOthers1.ClsDeleteErrorTransaction("JV");
        ...
        private void printcurvoucher()
        {
            ...
            sqlstatement = "SELECT CustName, Reference, DocNum, TDate, Term, PA, TitleAcct, Debit, Credit, UserName, Remarks FROM viewbookjv WHERE DocNum ='" + txtDocNum.Text + "'";
        ...
        private void btnActGroup_Click(object sender, EventArgs e)
        {
            ...
            frmActGroupJV1.Show();
            frmActGroupJV.glbltxtVoucher.Text = "JV";
        }

        private void btnCustBal_Click(object sender, EventArgs e)
        {
            if (txtTDate.Text == "  /  /")
            {
                MessageBox.Show("Please enter date","GL");
                txtTDate.Focus();
            }
            else
            {
            frmDoubtfulAct frmDoubtfulAct1 = new frmDoubtfulAct();
            frmDoubtfulAct1.Show();
            }
        }
        ...
        private void btnVAT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                frmVATEntry1.Show();
                frmVATEntry.glbltxtVoucher.Text = "JV";
