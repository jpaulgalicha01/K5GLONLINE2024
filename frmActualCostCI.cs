...
{
    public partial class frmActualCostCI : Form
    {
        ...
        private void buildlvActCost()
        {
            try
            {
                ...
                myconnection.Open();
                mycommand = new SqlCommand("SELECT RefforAC, MaxTDate, SumBal, MaxActualCost FROM ViewActualCostProducts2 WHERE StockNumber = '"+frmVoucherCI.glblcboStockNumber.SelectedValue.ToString()+"'", myconnection);
        ...
        private void frmActualCostCI_Load(object sender, EventArgs e)
        {
            buildlvActCost();
        }
        ...
        private void LVpso_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (LVActCost.SelectedItems.Count > 0)
            {
                ...
                frmVoucherCI.glbltxtCostRef.Text = itm.SubItems[0].Text;
                frmVoucherCI.glbltxtCost.Text = itm.SubItems[3].Text;
            }
        }
