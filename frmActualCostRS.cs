...
{
    public partial class frmActualCostRS : Form
    {
        ...
        private void buildlvActCost()
        {
            try
            {
                ...
                myconnection.Open();
                mycommand = new SqlCommand("SELECT RefforAC, MaxTDate, SumBal, MaxActualCost FROM ViewActualCostProducts2 WHERE StockNumber = '"+frmVoucherRS.glblcboStockNumber.SelectedValue.ToString()+"'", myconnection);
        ...
        private void frmActualCostRS_Load(object sender, EventArgs e)
        {
            buildlvActCost();
        }
        ...
        private void LVpso_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (LVActCost.SelectedItems.Count > 0)
            {
                ...
                frmVoucherRS.glbltxtCostRef.Text = itm.SubItems[0].Text;
                frmVoucherRS.glbltxtCost.Text = itm.SubItems[3].Text;
            }
        }
