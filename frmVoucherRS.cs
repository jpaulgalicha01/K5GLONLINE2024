...
{
    public partial class frmVoucherRS : Form
    {
        ...
        public static ComboBox glblcboStockNumber, glblcboControlNo;
        ...
        public frmVoucherRS()
        {
            InitializeComponent();
            {
                ClsGetSomethingOthers1.ClsGetVoidRef("RS");
                privarstrVoidIC = ClsGetSomethingOthers1.plsVoidIC;
                if (new ClsValidation().emptytxt(privarstrVoidIC))
                { }
                else
                {
                    ClsGetSomethingOthers1.ClsDeleteErrorTransaction("RS");
                }
            }
        }

        private void frmVoucherRS_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ClsAutoNumber1.VoucherAutoNum("RS");
        ...
        private void buildcboRemarks1()
        {
            cboRemarks1.DataSource = null;
            ClsBuildVoucherComboBox1.ARLRemarks1.Clear();
            ClsBuildVoucherComboBox1.ClsBuildRemarks1();
            this.cboRemarks1.DataSource = (ClsBuildVoucherComboBox1.ARLRemarks1);
            this.cboRemarks1.DisplayMember = "Display";
            this.cboRemarks1.ValueMember = "Value";
            this.cboRemarks1.DropDownWidth = 450;
            this.cboRemarks1.SelectedValue = "00";
        }

        private void buildcboReason()
        {
            cboReason.DataSource = null;
            ClsBuildVoucherComboBox1.ARLReturnIndCode.Clear();
            ClsBuildVoucherComboBox1.ClsBuildReason();
            this.cboReason.DataSource = (ClsBuildVoucherComboBox1.ARLReturnIndCode);
            this.cboReason.DisplayMember = "Display";
            this.cboReason.ValueMember = "Value";
            this.cboReason.DropDownWidth = 450;
            this.cboReason.SelectedValue = "00";
        }
        ...
        private void cboControlNo_Validating(object sender, CancelEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (cboAcctNo.SelectedValue.ToString() == "1500000")
                    {
                        txtUnpdRefer.Text = "";
       ...
       !String.IsNullOrEmpty(values[2]) || !String.IsNullOrEmpty(values[3]))
        ...
        private void RSSave()
        {
            try
            {
                ...
                sqlstatement = "INSERT INTO tblmain1 (IC, DocNum, Voucher, UserName, TDate, VDate, Reference, ControlNo, Remarks,  Term, Check#, CAmount, PC, DE, SONumber, PONum, CreditSales, CheckPayment, D1, D2, D3, RIVTransact, Void, RemarksCode, ReturnIndCode, PoultryTransact)";
                sqlstatement += " Values (@_IC, @_DocNum, @_Voucher, @_UserName, @_TDate, @_VDate, @_Reference, @_ControlNo, @_Remarks,  @_Term, @_Check#, @_CAmount, @_PC, @_DE, @_SONumber, @_PONum, @_CreditSales, @_CheckPayment, @_D1, @_D2, @_D3, @_RIVTransact, @_Void, @_RemarksCode, @_ReturnIndCode, @_PoultryTransact)";
                ...
                mycommand.Parameters.Add("_IC", SqlDbType.VarChar).Value = "RS" + Form1.glbluc.Text;
                ...
                mycommand.Parameters.Add("_SONumber", SqlDbType.VarChar).Value = "RS" + txtDocNum.Text;
                ...
                mycommand.Parameters.Add("_RemarksCode", SqlDbType.VarChar).Value = cboRemarks1.SelectedValue.ToString();
                mycommand.Parameters.Add("_ReturnIndCode", SqlDbType.VarChar).Value = cboReason.SelectedValue.ToString();
                mycommand.Parameters.Add("_PoultryTransact", SqlDbType.Char).Value = Convert.ToChar(cbPoulty.CheckState);
                ...
                for (int x = 0; x < dgv2.Rows.Count - 1; x++)
                {
                    ...
                    mycommanddgv2.Parameters.Add("_IC", SqlDbType.VarChar).Value = "RS" + Form1.glbluc.Text;
                ...
                myconnection.Close();
                ClsGetSomethingOthers1.ClsFinalize("RS", txtDocNum.Text);
        ...
        private void clearscreen()
        {
            ...
            txtTDate.Text = ClsGetSomething1.plsdefdate;
            txtVDate.Text = ClsGetSomething1.plsdefdate;
            cboRemarks1.SelectedValue = "00";
            cboReason.SelectedValue = "00";
        }
        private void getAcctEntry()
        {
            ...
            //Sales
            dgv1.Rows.Add("5000000", txtreference.Text, vartotalSales.ToString("N2"), "0.00");
            //Discount
            dgv1.Rows.Add(5100000, txtreference.Text, "0.00", vartotalDisct.ToString("N2"));
            //Vat Output
            dgv1.Rows.Add("3150000", txtreference.Text, vartotalVAT.ToString("N2"), "0.00");
            //Cost of Goods Sold
            dgv1.Rows.Add("6000000", txtreference.Text, "0.00", vartotalcost.ToString("N2"));
            //Merchandise Inventory
            dgv1.Rows.Add("1850000", txtreference.Text, vartotalcost.ToString("N2"), "0.00");
            dgv1total();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                myconnection.Close();
                privarstrVoidIC = null;
                ClsGetSomethingOthers1.ClsGetTDoor("RS");
                ...
                if (varintTableDoor == 0 && number <= 20)
                {
                    ...
                    if (new ClsValidation().emptytxt(privarstrVoidIC))
                    {
                        ClsGetSomethingOthers1.ClsOneTheDoor("RS");
                        RSSave();
                        ClsGetSomethingOthers1.ClsZeroTheDoor("RS");
                    }
                    else
                    {
                        ClsGetSomethingOthers1.ClsDeleteErrorTransaction("RS");
        ...
        private void frmVoucherRS_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void cboRemarks1_SelectedIndexChanged(object sender, EventArgs e)
        {
            //txtRemarks.Text = cboRemarks1.Text;
        }
    }
}
