...
{
    public partial class frmVoucherCV : Form
    {
        ...
        public frmVoucherCV()
        {
            InitializeComponent();
            {
                ClsGetSomethingOthers1.ClsGetVoidRef("CV");
                privarstrVoidIC = ClsGetSomethingOthers1.plsVoidIC;
                if (new ClsValidation().emptytxt(privarstrVoidIC))
                { }
                else
                {
                    ClsGetSomethingOthers1.ClsDeleteErrorTransaction("CV");
                }
            }

        }

        private void frmVoucherCV_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                ClsAutoNumber1.VoucherAutoNum("CV");
        ...
        private void CVSave()
        {
            try
            {
                ...
                mycommand.Parameters.Add("_IC", SqlDbType.VarChar).Value = "CV" + Form1.glbluc.Text;
                mycommand.Parameters.Add("_DocNum", SqlDbType.VarChar).Value = Form1.glbluc.Text;
                mycommand.Parameters.Add("_Voucher", SqlDbType.VarChar).Value = "CV";
                ...
                mycommand.Parameters.Add("_SONumber", SqlDbType.VarChar).Value = "CV" + txtDocNum.Text;
                ...
                string sqlstatementpcv;
                sqlstatementpcv = "UPDATE tblMainPark1 set Post=@_Post  WHERE DocNum ='" + varsearchtxt + "' AND Voucher = 'CV'";
                mycommand = new SqlCommand(sqlstatementpcv, myconnection);
                mycommand.Parameters.Add("_Post", SqlDbType.Bit).Value = 1;
                mycommand.CommandTimeout = 600;
                int n3 = mycommand.ExecuteNonQuery();

                myconnection.Close();
                ClsGetSomethingOthers1.ClsFinalize("CV", txtDocNum.Text);
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
                ...
                else
                {
                    myconnection.Close();
                    privarstrVoidIC = null;
                    ClsGetSomethingOthers1.ClsGetTDoor("CV");
                    ...
                    if (varintTableDoor == 0 && number <= 20)
                    {
                        ...
                        if (new ClsValidation().emptytxt(privarstrVoidIC))
                        {
                            ClsGetSomethingOthers1.ClsOneTheDoor("CV");
                            CVSave();
                            ClsGetSomethingOthers1.ClsZeroTheDoor("CV");
                        }
                        else
                        {
                            ClsGetSomethingOthers1.ClsDeleteErrorTransaction("CV");
        ...
        private void printcurvoucher()
        {
            ...
            sqlstatement = "SELECT * FROM viewbookcv WHERE DocNum ='" + txtDocNum.Text + "'";
        ...
        private void btnActGroup_Click(object sender, EventArgs e)
        {
            ...
            frmActGroupJV1.Show();
            frmActGroupJV.glbltxtVoucher.Text = "CV";
        }
        ...
        private void btnVAT_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                frmVATEntry1.Show();
                frmVATEntry.glbltxtVoucher.Text = "CV";
